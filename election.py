...
for row in rows:
    ...
    image = Image.open("Election.png")
    draw = ImageDraw.Draw(image)

    name_font = ImageFont.truetype("./gabriola.ttf", 235)
    ...
    name_coordinates = (1525 - wname / 2, 1130)
    ...
    category_coordinates = (1525 - wcat / 2, 1500)
